...
class AppColors {
  ...
  static const Color secondary = Color(0xFF121223);
  static const Color greyLite = Color(0xFFF6F6F6);
  static const Color imageBackground = Color(0xFF98A8B8);
  static const Color description = Color(0xFFA0A5BA);
  static const Color ingredients = Color(0xFFFFEBE4);
